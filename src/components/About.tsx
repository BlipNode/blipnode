...
import { Award, Clock, Code, Database, Globe, Monitor, Shield, Smartphone, Zap } from 'lucide-react';
    ...
    const expertise = [
        {
            ...
            technologies: ["Flutter", "Dart", "Flet"]
        },
        {
            icon: Code,
            title: "Web Development",
            description: "Full-stack web applications using cutting-edge frameworks and technologies for maximum performance.",
            technologies: ["React", "Tailwind", "Node.js", "TypeScript"]
        },
        {
            icon: Monitor,
            title: "Desktop Development",
            description: "Smart desktop applications that automate tasks, optimize processes, and deliver efficient user experiences.",
            technologies: ["Flutter", "Dart", "FastAPI", "PostgreSQL"]
        },
        {
            icon: Database,
