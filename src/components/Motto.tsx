...
const Motto = () => {
    ...
    return (
        <section className="py-24 relative overflow-hidden">
            ...
            <div ref={ref} id="motto" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                {/* Main Motto */}
                ...
                >
                    <div className="bg-gradient-to-r from-slate-900/50 to-slate-800/30 backdrop-blur-sm border border-cyan-500/20 rounded-3xl p-12 max-w-4xl mx-auto">
                        <blockquote className="text-2xl md:text-3xl font-light text-slate-200 leading-relaxed mb-6">
                            "Technology, when used correctly, is a powerful tool to
                            <span className="text-gradient font-semibold"> achieve your dreams</span>."
                        </blockquote>
                        <div className="flex items-center justify-center space-x-4">
                            ...
                            <div className="text-left">
                                ...
                                <div className="text-slate-400 text-sm">Founder and CEO</div>
                            </div>
                        </div>
                    </div>
                </motion.div>
